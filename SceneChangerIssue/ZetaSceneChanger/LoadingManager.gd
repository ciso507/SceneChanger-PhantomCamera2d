...
var _load_screen_path:String = "res://Core/loading_screen.tscn"
...
func _process(_delta):
	...
	match load_status:
		...
		3: #THREAD_LOAD_LOADED
			print("process loadLOADED")
			_loaded_resource = ResourceLoader.load_threaded_get(_scene_path)
			emit_signal("progress_changed", 1.0) # 1.0 is the same as _progress[0]
